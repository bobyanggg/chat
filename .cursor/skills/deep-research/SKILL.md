---
name: deep-research
description: Broad parallel web searches and a cited Markdown report. Use only when the user invokes /deep-research.
...
Do not run this skill for casual questions, "look into X", or a normal answer. Wait for `/deep-research`.
