...
description: Summarize deep research JSON results into a markdown report covering all fields and skipping uncertain values. Use after /research-deep when the user invokes /research-report.
